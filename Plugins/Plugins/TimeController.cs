...
{
    public class TimeController : MFW3D.PluginEngine.Plugin
    {
        string basePath = System.IO.Path.GetDirectoryName(System.Windows.Forms.Application.ExecutablePath);
        MFW3D.NewWidgets.FormWidget m_window = null;
        MFW3D.NewWidgets.PictureBox time = null;
        MFW3D.NewWidgets.PictureBox play = null;
        MFW3D.NewWidgets.PictureBox close = null;
        MFW3D.NewWidgets.PictureBox pause = null;
        MFW3D.NewWidgets.PictureBox slow = null;
        MFW3D.NewWidgets.PictureBox fast = null;
        MFW3D.NewWidgets.PictureBox rewind = null;
        MFW3D.NewWidgets.TextLabel timeLabel = null;
        MFW3D.NewWidgets.WidgetMenuButton m_toolbarItem = null;

        public override void Load()
        {
            try
            {
                m_window = new MFW3D.NewWidgets.FormWidget("Time Control");
                ...
                m_window.Anchor = MFW3D.NewWidgets.WidgetEnums.AnchorStyles.Left | MFW3D.NewWidgets.WidgetEnums.AnchorStyles.Bottom;
                ...
                time = new MFW3D.NewWidgets.PictureBox();
                time.Name = "Time";
                ...
                play = new MFW3D.NewWidgets.PictureBox();
                play.Name = "Play";
                ...
                close = new MFW3D.NewWidgets.PictureBox();
                close.Name = "Close";
                ...
                rewind = new MFW3D.NewWidgets.PictureBox();
                rewind.Name = "Rewind";
                ...
                pause = new MFW3D.NewWidgets.PictureBox();
                pause.Name = "Pause";
                if (TimeKeeper.Enabled)
                {
                ...
                slow = new MFW3D.NewWidgets.PictureBox();
                slow.Name = "Slow";
                ...
                fast = new MFW3D.NewWidgets.PictureBox();
                fast.Name = "Fast";
                ...
                timeLabel = new MFW3D.NewWidgets.TextLabel();
                ...
                m_toolbarItem = new MFW3D.NewWidgets.WidgetMenuButton(
                    "Time Controller",
