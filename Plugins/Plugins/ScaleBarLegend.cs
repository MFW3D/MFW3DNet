...
{
    public class ScaleBarLegend : MFW3D.PluginEngine.Plugin
    {
    ...
    public class ScaleBarWidget : IWidget
    {
        ...
        private void renderBackbone(DrawArgs drawArgs)
        {
            ...
            MFW3D.Menu.MenuUtils.DrawBox(AbsoluteLocation.X, AbsoluteLocation.Y - backboneWidth + ClientSize.Height, ClientSize.Width, backboneWidth, 0.0f, m_ForeColor.ToArgb(), drawArgs.device);
            ...
            MFW3D.Menu.MenuUtils.DrawLine(m_vectors, m_ForeColor.ToArgb(), drawArgs.device);
