...
namespace MFW3D
{
	...
	public class WMSBrowser : System.Windows.Forms.Form
	{
		...
		string saved_dirpath = Path.Combine(MFW3D.Global.Settings.DirectoryPath, 
		...
		private void InitializeComponent()
		{
            ...
            // 
            this.treeViewTableOfContents.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(151)))), ((int)(((byte)(151)))), ((int)(((byte)(151)))));
            this.treeViewTableOfContents.Dock = System.Windows.Forms.DockStyle.Fill;
            this.treeViewTableOfContents.ForeColor = System.Drawing.Color.White;
            ...
            // buttonLegend
            // 
            this.buttonLegend.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(151)))), ((int)(((byte)(151)))), ((int)(((byte)(151)))));
            ...
            // tabPageSingleImage
            // 
            this.tabPageSingleImage.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(111)))), ((int)(((byte)(111)))), ((int)(((byte)(111)))));
            ...
            // tabPageAnimation
            // 
            this.tabPageAnimation.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(111)))), ((int)(((byte)(111)))), ((int)(((byte)(111)))));
		...
		private void treeViewTableOfContents_AfterSelect(object sender, System.Windows.Forms.TreeViewEventArgs e)
		{
			if(e.Node.Tag != null)
			{
                ...
                if (curLayer.Dates != null && curLayer.Dates.Length > 0)
                {
                    ...
                    // this doesn't correct the default date...
                    // TODO: make it select the default date if it exists
	...
	class MyWMSLayer
	{
		...
		public string GetWMSRequestUrl(string date, string style, decimal north, decimal south, decimal west, decimal east)
		{
            ...
            string getMapUrl;
            if (this.ParentWMSList.ServerGetMapUrl.EndsWith("&", StringComparison.InvariantCulture))
                getMapUrl = this.ParentWMSList.ServerGetMapUrl;
            else if (this.ParentWMSList.ServerGetMapUrl.EndsWith("?", StringComparison.InvariantCulture))
                getMapUrl = this.ParentWMSList.ServerGetMapUrl;
            else
                getMapUrl = this.ParentWMSList.ServerGetMapUrl + "?";
