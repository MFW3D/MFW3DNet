...
namespace bNb.Plugins
{
    ...
    public class GoogleMapsForm : System.Windows.Forms.Form
    {
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            lock (m_WorldWindow.CurrentWorld.RenderableObjects.ChildObjects.SyncRoot)
            {
                ...
                {
                    if (ro is MFW3D.Renderable.RenderableObjectList && ro.Name.IndexOf("Images") >= 0)
                    {
        ...
        private MFW3D.WorldWindow m_WorldWindow = null;
        public MFW3D.WorldWindow WorldWindow
        {
    ...
    public class GoogleMapsPlugin : MFW3D.PluginEngine.Plugin
    {
