...
namespace NASA.Plugins
{
    ...
    public class BMNG : System.Windows.Forms.Form
    {
        ...
        MFW3D.Renderable.RenderableObjectList m_BlueMarbleList = null;
        MFW3D.Renderable.RenderableObjectList m_ShadedList = null;
        MFW3D.Renderable.RenderableObjectList m_ShadedBathyList = null;

        MFW3D.Renderable.ImageLayer m_BlueMarbleBase = null;
        MFW3D.Renderable.QuadTileSet m_BlueMarbleTiled = null;
        MFW3D.Renderable.RenderableObjectList m_RenderableList = new MFW3D.Renderable.RenderableObjectList("The Blue Marble");

        MFW3D.Renderable.RenderableObjectList[,] m_RenderableLayers = new MFW3D.Renderable.RenderableObjectList[3, 12];
        MFW3D.Renderable.ImageLayer[,] m_ImageLayers = new MFW3D.Renderable.ImageLayer[3, 12];
        MFW3D.Renderable.QuadTileSet[,] m_QuadTileLayers = new MFW3D.Renderable.QuadTileSet[3, 12];
        public MFW3D.WorldWindow m_WorldWindow = null;
        ...
        private void InitializeComponent()
        {
            ...
            this.trackBarMonth.Size = new System.Drawing.Size(352, 42);
        ...
        {
            MFW3D.World.Settings.BmngVersion = comboBoxBmngVersion.SelectedIndex;
        }
    ...
    public class BmngLoader : MFW3D.PluginEngine.Plugin
    {
