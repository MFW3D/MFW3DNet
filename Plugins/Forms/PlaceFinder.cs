...
namespace MFW3D
{
	...
	public class PlaceFinder : System.Windows.Forms.Form
	{
		...
		MFW3D.WorldWindow m_WorldWindow = null;
		...
		public PlaceFinder(MFW3D.WorldWindow ww)
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            this.textBoxWWFeature = new MFW3D.EnterTextBox();
            ...
            this.VEenterTextBox = new MFW3D.EnterTextBox();
            ...
            this.GMenterTextBox = new MFW3D.EnterTextBox();
            ...
            this.enterTextBox1 = new MFW3D.EnterTextBox();
            ...
            this.enterTextBox2 = new MFW3D.EnterTextBox();
            ...
            this.enterTextBox3 = new MFW3D.EnterTextBox();
            this.pictureBox1 = new System.Windows.Forms.PictureBox();
            this.pictureBox8 = new System.Windows.Forms.PictureBox();
            this.button10 = new System.Windows.Forms.Button();
            this.enterTextBox4 = new MFW3D.EnterTextBox();
            this.button11 = new System.Windows.Forms.Button();
            this.pictureBox9 = new System.Windows.Forms.PictureBox();
            this.enterTextBox5 = new MFW3D.EnterTextBox();
    ...
    "ses";
		...
		private void SearchOnline()
		{
			...
			try
			{
				...
				try
                {
					...
					MFW3D.Net.WebDownload dl = new MFW3D.Net.WebDownload(searchUriString);
					dl.Compressed = true;
					dl.DownloadMemory();
		...
		private string[] getWplFiles(MFW3D.Renderable.RenderableObject ro)
		{
			if(ro is MFW3D.Renderable.TiledPlacenameSet)
			{
			...
			else if(ro is MFW3D.Renderable.RenderableObjectList)
			{
				MFW3D.Renderable.RenderableObjectList rol = (MFW3D.Renderable.RenderableObjectList)ro;
				ArrayList wplFiles = new ArrayList();

				foreach(MFW3D.Renderable.RenderableObject childRo in rol.ChildObjects)
				{
	...
	public class PlaceFinderLoader : MFW3D.PluginEngine.Plugin
	{
		MenuItem m_MenuItem;
