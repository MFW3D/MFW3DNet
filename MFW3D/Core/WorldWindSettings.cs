...
namespace MFW3D
{
	...
	/// 配置
	/// </summary>
	public class WorldWindSettings : MFW3D.Configuration.SettingsBase
	{
		...
		{
			MFW3D.Net.WebDownload.useWindowsDefaultProxy = this.useWindowsDefaultProxy;
			MFW3D.Net.WebDownload.useDynamicProxy        = this.useDynamicProxy;
			MFW3D.Net.WebDownload.proxyUrl               = this.proxyUrl;
			MFW3D.Net.WebDownload.proxyUserName          = this.proxyUsername;
			MFW3D.Net.WebDownload.proxyPassword          = this.proxyPassword;
		}
