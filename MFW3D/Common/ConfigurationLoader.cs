	...
	public class ConfigurationLoader
	{
                ...
                */
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        {
                            MFW3D.Net.WebDownload download = new MFW3D.Net.WebDownload(layerFile);
                ...
                if (iter.Count > 0)
                {
                    ...
                    else
                    {
                        ...
                        if (renderPriorityString != null)
                        {
                            ...
                            else if (String.Compare(renderPriorityString, "TerrainMappedImages", false, System.Globalization.CultureInfo.InvariantCulture) == 0)
                            {
        ...
        private static ImageStore getImageStoreFromXPathNodeIterator(string name, XPathNodeIterator imageAccessorIter, RenderableObjectList parentRenderable, Cache cache)
        {
			...
			if(wmsAccessorIter.Count > 0)
			{
				...
				MFW3D.Net.Wms.WmsImageStore wmsLayerStore = new MFW3D.Net.Wms.WmsImageStore();
			...
			if(iter.Count > 0)
			{
				while(iter.MoveNext())
				{
					...
					if(startXString != null && startYString != null)
					{
						...
						MFW3D.Renderable.ScreenOverlay overlay = new ScreenOverlay(name, startX, startY, imageUri);
