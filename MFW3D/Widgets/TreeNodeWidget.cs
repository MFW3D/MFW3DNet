...
namespace MFW3D.NewWidgets
{
	...
	public abstract class TreeNodeWidget : WidgetCollection, IWidget, IInteractive
	{
		...
		protected MFW3D.Renderable.RenderableObject m_renderableObject;
		...
		public MFW3D.Renderable.RenderableObject RenderableObject
		{
        ...
        {
            get { return m_enterAction; }
            set { m_enterAction = value; }
        }

        protected MouseClickAction m_leaveAction;
        public MouseClickAction LeaveAction
        {
            get { return m_leaveAction; }
            set { m_leaveAction = value; }
        }
		...
		public bool OnMouseUp(System.Windows.Forms.MouseEventArgs e)
		{
			...
			if (!handled)
			{
				for(int i = 0; i < m_subNodes.Count; i++)
				{
                    if (m_subNodes[i] is UpdateWidget)
                    {
                        UpdateWidget currentWidget = m_subNodes[i] as UpdateWidget;
