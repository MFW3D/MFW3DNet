...
namespace MFW3D.KMLReader
{
    public class KMLParser
    {
        ...
        {
            foreach (MFW3D.Renderable.RenderableObject ro in layer.ChildObjects)
            {
        ...
        private void ParseGroundOverlays(XmlNode inNode, Icons layer)
        {
            ...
            foreach (XmlNode node in groundOverlays)
            {
                ...
                if (latLonBoxNode != null)
                {
                    ...
                    MFW3D.Renderable.ImageLayer imageLayer = new ImageLayer(
                        name,
        ...
        private static void RemoveUnusedIcons(Icons layer)
        {
            ...
            foreach (MFW3D.Renderable.RenderableObject ro in VFD)
            {
                layer.Remove(ro);
                ro.Dispose();
            }
