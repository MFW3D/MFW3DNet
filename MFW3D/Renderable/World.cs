...
/*		public string DataDirectory
		...
		public override void Render(DrawArgs drawArgs)
		{
			...
			try
			{
                ...
                Render(RenderableObjects, (MFW3D.Renderable.RenderPriority)(-1), drawArgs);
				...
				Render(RenderableObjects, MFW3D.Renderable.RenderPriority.TerrainMappedImages, drawArgs);
				...
				Render(RenderableObjects, MFW3D.Renderable.RenderPriority.AtmosphericImages, drawArgs);
                DirectXProfiler.EndEvent();

                DirectXProfiler.BeginEvent("render line paths");
                //render LinePaths
                Render(RenderableObjects, MFW3D.Renderable.RenderPriority.LinePaths, drawArgs);
                DirectXProfiler.EndEvent();

                DirectXProfiler.BeginEvent("render placenames");
                //render Placenames
                if (World.Settings.ShowPlacenames)
                    Render(RenderableObjects, MFW3D.Renderable.RenderPriority.Placenames, drawArgs);
                DirectXProfiler.EndEvent();

                DirectXProfiler.BeginEvent("render icons");
				//render Icons
				Render(RenderableObjects, MFW3D.Renderable.RenderPriority.Icons, drawArgs);
                DirectXProfiler.EndEvent();

                DirectXProfiler.BeginEvent("render custom");
                //render Custom
				Render(RenderableObjects, MFW3D.Renderable.RenderPriority.Custom, drawArgs);
                DirectXProfiler.EndEvent();
		...
		private void RenderStars(DrawArgs drawArgs, MFW3D.Renderable.RenderableObject renderable)
		{
		...
		private void Render(MFW3D.Renderable.RenderableObject renderable, MFW3D.Renderable.RenderPriority priority, DrawArgs drawArgs)
		{
			...
			try
			{
                ...
                {
                    ((MFW3D.Renderable.RenderableObjectList)renderable).RenderChildren(drawArgs, priority);
                }
                // hack at the moment
                else if (priority == MFW3D.Renderable.RenderPriority.TerrainMappedImages)
                {
                    if (renderable.RenderPriority == MFW3D.Renderable.RenderPriority.SurfaceImages || renderable.RenderPriority == MFW3D.Renderable.RenderPriority.TerrainMappedImages)
                    {
                        renderable.Render(drawArgs);
                    }
                }
	...
	public class AtmosphericScatteringSphere
	{
		...
		{
			MFW3D.Camera.CameraBase camera = drawArgs.WorldCamera;
