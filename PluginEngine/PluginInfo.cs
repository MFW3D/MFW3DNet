...
namespace WorldWind.PluginEngine
{
	...
	public class PluginInfo
	{
		...
		public bool IsLoadedAtStartup
		{
			get
			{
				foreach(string startupId in m_parentApplication.Settings.PluginsLoadedOnStartup)
					if(ID==startupId)
						return true;
				return false;
			}
			set
			{
                ArrayList startupPlugins = m_parentApplication.Settings.PluginsLoadedOnStartup;
