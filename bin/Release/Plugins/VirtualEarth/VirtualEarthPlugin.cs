...
// REFERENCES: 
//----------------------------------------------------------------------------
// 1.5  Mar 31, 2007    Uses internal/external browser setting
...
namespace bNb.Plugins
{
    ...
    public class VirtualEarthForm : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.pictureBox1.InitialImage = Image.FromFile(Path.GetDirectoryName(System.Windows.Forms.Application.ExecutablePath) + "\\Plugins\\VirtualEarth\\vejewel.png");
            this.pictureBox1.Image = Image.FromFile(Path.GetDirectoryName(System.Windows.Forms.Application.ExecutablePath) + "\\Plugins\\VirtualEarth\\vejewel.png");
        ...
        private void btnLocalLive_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                {
                    SplitContainer sc = (SplitContainer)this.WorldWindow.Parent.Parent;
